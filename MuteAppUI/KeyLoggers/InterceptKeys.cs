...
namespace MuteAppUI.KeyLoggers
{
    internal class InterceptKeys
    {
        ...
        public static IntPtr SetHook(LowLevelKeyboardProc proc, HookCallbackDelegate cb)
        {
        ...
        public delegate void HookCallbackDelegate(string phrase);
